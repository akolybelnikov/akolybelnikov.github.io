...
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/go-app","GOAPP_STATIC_RESOURCES_URL":"/go-app","GOAPP_VERSION":"9a57d5e3e1d1ec26c08405a927b0343957040e6d"};
...
async function goappInitWebAssembly() {
  ...
  try {
    ...
    const wasm = await instantiateStreaming(
      fetchWithProgress("/go-app/web/app.wasm", showProgress),
      go.importObject
    );
